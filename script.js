...
const EVENTS = [
  {
    ...
    fights: [
      ...
      { a: "Serghei Spivac", b: "Vitor Petrino", pA: 35.7, pB: 64.3, oA: 134, oB: -168, me: false, result: null, charts: "fights/SERGHEI SPIVAC_vs_VITOR PETRINO" },
      ...
      { a: "Reinier de Ridder", b: "Roman Dolidze", pA: 71.2, pB: 28.8, oA: -382, oB: 330, me: false, result: null, charts: "fights/REINIER DE RIDDER_vs_ROMAN DOLIDZE" },
      { a: "Kennedy Nzechukwu", b: "Shamil Gaziev", pA: 67.1, pB: 32.9, oA: 114, oB: -137, me: false, result: null, charts: "fights/KENNEDY NZECHUKWU_vs_Shamil Gaziev" },
      { a: "Chris Padilla", b: "Nasrat Haqparast", pA: 71.9, pB: 28.1, oA: -103, oB: -117, me: false, result: null, charts: "fights/Chris Padilla_vs_NASRAT HAQPARAST" },
    ]
  },
  {
    ...
    status: "completed",
    fights: [
      { a: "Islam Makhachev", b: "Ian Machado Garry", pA: 58.2, pB: 41.8, oA: -317, oB: 300, me: true, result:"A", charts: "fights/ISLAM MAKHACHEV_vs_IAN MACHADO GARRY"},
      { a: "Mansur Abdul-Malik", b: "Dustin Stoltzfus", pA: 84.6, pB: 15.4, oA: -614, oB: 567, me: false, result:"B", charts: 'fights/MANSUR ABDUL-MALIK_vs_DUSTIN STOLTZFUS'},
      { a: "Edson Barboza", b: "Esteban Ribovics", pA: 36.0, pB: 64.0, oA: 525, oB: -567, me: false , charts: "fights/EDSON BARBOZA_vs_Esteban Ribovics", result:"B"},
      { a: "Jalin Turner", b: "Kaue Fernandes", pA: 42.6, pB: 57.4, oA: -150, oB: +144, me: false, edge :true , charts:"fights/JALIN TURNER_vs_KAUE FERNANDES", result:"A"},
      { a: "Neil Magny", b: "Ramiz Brahimaj", pA: 57.0, pB: 43.0, oA: 127, oB: -133, me: false, edge :true , charts:"fights/NEIL MAGNY_vs_RAMIZ BRAHIMAJ", result:"A"},
      { a: "Vicente Luque", b: "Tresean Gore", pA: 68.8, pB: 31.2, oA: 104, oB: -108, me: false, edge :true , charts:"fights/Vicente Luque_vs_Tresean Gore", result:"B"},
      { a: "Chidi Njokuani", b: "Joel Alvarez", pA: 34.4, pB: 65.6, oA: 252, oB: -307, me: false, edge :true , charts:"fights/CHIDI NJOKUANI_vs_Joel Alvarez", result:"A"},
      { a: "Donte Johnson", b: "Eric McConico", pA: 90.8, pB: 9.2, oA: -277, oB: +217, me: false, edge:true, charts:"fights/DONTE JOHNSON_vs_Eric McConico", result:"A"},
      { a: "Jeremiah Wells", b: "Myktybek Orolbai", pA: 21.5, pB: 78.5, oA: +733, oB: -809, me: false , charts: "fights/JEREMIAH WELLS_vs_MYKTYBEK OROLBAI", result:"A"},
    ]
  },
  {
